...
import com.PRS.Consultorio.Reportes.clsRDineroCC;
 ...
 * @author cycclon
 */
public class ctrlDineroCC implements Initializable, iMensajeable {
    ...
    private void MostrarReporte()
    {
        try
        {
            clsRDineroCC rdp = new clsRDineroCC();
    ...
    @Override
    public String getNombre() {return "Reporte dinero por centro de costo.";}
